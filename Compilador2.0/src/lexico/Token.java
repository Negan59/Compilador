...
public class Token {
	...
	public static final int TK_ASSIGN      = 4;
		...
		public static final int TK_END = 12;
                public static final int TK_EOF = 13;
	
	public static final String TK_TEXT[] = {
			"IDENTIFICADOR", "NUMERO", "OPERADOR ARITMÉTICO", "PONTUAÇÃO", "ATRIBUIÇÃO","OPERADOR RELACIONAL","OPERADOR CONDICIONAL IF","OPERADOR CONDICIONAL THEN","OPERADOR CONDICIONAL ELSE","OPERADOR DE REPETIÇÃO WHILE","OPERADOR DE REPETIÇÃO DO","OPERADOR DE REPETIÇÃO FOR","FINAL DO TRECHO","FINAL DE LINHA"
	};
